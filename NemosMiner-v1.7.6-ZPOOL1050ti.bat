...
SET A21=bitcore
SET A22=hmq1725
SET PASS=c=BTC,equihash=0.18,lyra2z=0.57,myr-gr=27,lyra2v2=15.6,neoscrypt=0.49,decred=1.05,blakecoin=1.9,c11=6.4,groestl=13.7,blake2s=1.55,x17=4.2,nist5=18.4,skein=208,sib=3.54,x11evo=5.23,lbry=111,timetravel=10.5,veltor=12.9,bitcore=6.5,hmq1725=1.84,stats
:start
...
%B% -d %GPUccminer% -r 0 -a %A17% -o stratum+tcp://%A17%.%POOL%:3553 -u %ADDY% -p %PASS% 
