...
SET A21=bitcore
SET A22=hmq1725
SET PASS=c=BTC,equihash=0.42,lyra2z=1.55,myr-gr=67,lyra2v2=37,neoscrypt=1.13,decred=2.6,blakecoin=4.8,c11=16.4,groestl=32,blake2s=3.5,x17=10.9,nist5=46.3,skein=500,sib=11.8,x11evo=12.5,lbry=272,timetravel=26,veltor=30,bitcore=16,hmq1725=4.58,stats
:start
